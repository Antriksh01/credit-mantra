        ...
        <div class="row">
            <div class="offset-xl-2 col-xl-8  col-md-12 col-12 ">
                <div class="mb-10 text-center">
                    <!-- section title start-->
                    <h1 class="text-white mb-1">Be in a safe place in an <span
                            style="color:#f1bd03fa; font-weight:bold">unsafe world</span> by Taking <span
                            style="color:#f1bd03fa; font-weight:bold">Credit Mantra's</span>
                        Insurance Plan
                    </h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="students-request-form">
                        <form method="post" action="https://easetemplate.com/borrow/pages/get-quote.php">
                            <div class="row g-2">
                                <p class="lead text-center" style="color:#f1bd03fa;">Submit an Enquiry
                                </p>
                                <!-- Text input-->
                                ...
                                <div class="mb-3 col-md-6 col-12">
                                    ...
                                    <select id="city" name="city" class="form-select border-0 ">
                                        <option value="Persnal Loan">General Insurance</option>
                                        <option value="Education Loan">Health Insurance</option>
                                        <option value="Car Loan">Automobile Insurance </option>
                                        <option value="Business Loan">Life Insurance</option>
                                        <option value="Persnal Loan">Two wheeler Insurance</option>
                                        <option value="Persnal Loan">Fire Insurance</option>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 form-opp">
                    <h2 style="color:#ffc107">Credit Mantra's Insurance Plans Provides</h2>
                    <ul class="text-white mt-5">
                        <li>Attractive Protection Plans</li>
                        <li>Tax Saving</li>
                        <li>Insurance Guidance</li>
                        <li>Maximum Benefits</li>
                        <li>Affordable Insurance Policies</li>
                    </ul>
                </div>
            </div>
        </div>
