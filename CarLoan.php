        ...
        <div class="row">
            <div class="offset-xl-2 col-xl-8  col-md-12 col-12 ">
                <div class="mb-10 text-center">
                    <!-- section title start-->
                    <h1 class="text-white mb-1">Drive your Dream Car with
                        <br /> <span style="color:#f1bd03fa; font-weight:bold">Credit Mantra's Car
                            Loan Plan</span>
                    </h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 form-opp">
                    <h2 style="color:#ffc107">Credit Mantra's Car Loan Provides</h2>
                    <p style="color:#ffc107; font-weight:bold">Car loan is a type of loan which allows you to buy car
                        for personal use based on our car loan eligiblity criteria.
                    </p>
                    <ul class="text-white mt-5">
                        <li>Minimum downpayment as 50 thousands </li>
                        <li>Low rate of interest</li>
                        <li>Preclosure facility</li>
                        <li>No additional charges</li>
                        <li>Tenure upto 7yrs</li>
                    </ul>
                </div>
