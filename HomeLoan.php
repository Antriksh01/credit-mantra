        ...
        <div class="row">
            <div class="offset-xl-2 col-xl-8  col-md-12 col-12 ">
                <div class="mb-10 text-center">
                    <!-- section title start-->
                    <h1 class="text-white mb-1">Affordable Home Loan Provided by
                        <br /> <span style="color:#f1bd03fa; font-weight:bold">Credit Mantra</span>
                    </h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 form-opp">
                    <h2 style="color:#ffc107">Credit Mantra's Home Loan Provides </h2>
                    <p style="color:#ffc107; font-weight:bold">Home loan is a type of loan which can be
                        borrowed to purchase new or resale home, land, to construct a home or renovate existing one.
                    </p>
                    <ul class="text-white mt-5">
                        <li>Affordable Downpayments</li>
                        <li>Feasible loan tenure</li>
                        <li>Fast Approvals</li>
                        <li>Lend Valuation</li>
                        <li>Property Document Compliance</li>
                    </ul>
                </div>
            </div>
        </div>
