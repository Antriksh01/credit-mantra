    ...
    <div class="row">
      <div class="offset-xl-2 col-xl-8  col-md-12 col-12 ">
        <div class="mb-10 text-center">
          <!-- section title start-->
          <h1 class="text-white mb-1">Get busy with your dream business by <br />
            <span style="color:#f1bd03fa; font-weight:bold">Credit Mantra's Business Loan</span>
          </h1>
    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 form-opp">
          <h2 style="color:#ffc107">Credit Mantra's Business Loan Provides</h2>
          <p style="color:#ffc107; font-weight:bold">Business loan is a type of loan which can only be borrowed against
            business/companies assets. It can be used for business renovation, staffing, business purchases and capital
            funds.

          </p>
          <ul class="text-white mt-5">
            <li>Fastest Approval</li>
            <li>Loan of up to Rs. 1 crore</li>
            <li>Best lending options</li>
            <li>Less documents required</li>
