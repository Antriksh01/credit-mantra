        ...
        <div class="row">
            <div class="offset-xl-2 col-xl-8  col-md-12 col-12 ">
                <div class="mb-10 text-center">
                    <!-- section title start-->
                    <h1 class="text-white mb-1"><span style="color:#f1bd03fa; font-weight:bold">Line of credit</span> is
                        a facility which has pre-set spending limit based on
                        <span style="color:#f1bd03fa; font-weight:bold">Credit Mantra's</span> eligiblity criteria
                    </h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 form-opp">
                    <h2 style="color:#ffc107">Credit Mantra's Line of Credit Provides </h2>
